...
{
    internal class ReadInputRegisters : ReadMap
    {
        public ReadInputRegisters(byte id, IModbusCommand mbCommand, DeviceInfo device, ushort maxNumberReadRegisters,
            short shift) : base(id, mbCommand, device, maxNumberReadRegisters, shift)
        {
            modbusMapType = ModbusMapType.ReadInputRegisters;
        }
        ...
        public override void Read()
        {
            ...
            {
                ushort[] inputs = master.ReadInputRegisters(slaveAddress, address, channelCount);
