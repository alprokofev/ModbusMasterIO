...
{
    internal class ReadCoils : ReadMap
    {
        public ReadCoils(byte id, IModbusCommand mbCommand, DeviceInfo device, ushort maxNumberReadRegisters,
            short shift) : base(id, mbCommand, device, maxNumberReadRegisters, shift)
        {
            modbusMapType = ModbusMapType.ReadCoils;
        }
        ...
        public override void Read()
        {
            ...
            {
                bool[] inputs = master.ReadCoils(slaveAddress, address, channelCount);
